...
- later unfroze the last resnet block (layer4) for fine-tuning with a smaller learning rate and learning rate scheduler <br>
...
- monitored validation accuracy improvements after fine-tuning <br>
